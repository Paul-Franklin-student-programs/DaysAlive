    ...
    companion object {
        ...
        fun getLifeStageMessage(daysAlive: Long): String {
            return when (daysAlive) {
                ...
                in 21915..25567 -> "Reflecting on a life well lived, with excitement of what's to come!" // 60 - 69 years
                ...
                else -> "Wow! You reached 100! You have had so many adventures already, but go ahead and have some more!" // 100+
            }
        }
